...
-- ALL_IN_ONE_FINAL_ANSWER;

CREATE OR REPLACE VIEW ALL_IN_ONE_FINAL_ANSWER AS
SELECT ORDER_ID, ORDER_EXTRACT, ORDER_DATE_NEW, SHIP_DATE_NEW, DISCOUNT, DISCOUNT_FLAG, PROCESS_DAY, RATING
FROM VJ_SALES_COPY;


SELECT *
FROM ALL_IN_ONE_FINAL_ANSWER;

DESCRIBE VIEW ALL_IN_ONE_FINAL_ANSWER;
